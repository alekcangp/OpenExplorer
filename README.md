...
* Wallet - the native OPEN Platform wallet is able to interact with OPEN chain, without the need to install any apps (this feature temporarily isn't available by cause the <a target='_blank' href = 'https://github.com/OpenFuturePlatform/open-chain/issues/8'>issue</a>.
